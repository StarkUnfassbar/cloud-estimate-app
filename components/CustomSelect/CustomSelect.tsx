...
export default function CustomSelect({ 
  ...
  const isRecommended = () => {
    ...
    return showRecommendationBadge && recommendedOption && selectedOption?.value === recommendedOption?.value;
  };
    ...
    <div className={styles['select-wrapper']} ref={selectRef}>
      ...
      <div className={styles['custom-select']}>
        ...
        >
          ...
          {isRecommended() && (
            <p className={styles['mark-recommendation']}>Рекомендуется</p>
          )}
          ...
          >
            {options.map((option) => (
              ...
              >
                ...
                {showRecommendationBadge && option.recommended && (
                  <span className={styles['option-recommendation-badge']}>Рекомендуется</span>
                )}
              </div>
            ))}
          </div>,
